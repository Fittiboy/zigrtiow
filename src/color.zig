...
pub fn writeTo(self: Self, writer: anytype) !void {
    ...
    const rbyte: u8 = @intFromFloat(255.999 * int.clamp(self.r));
    const gbyte: u8 = @intFromFloat(255.999 * int.clamp(self.g));
    const bbyte: u8 = @intFromFloat(255.999 * int.clamp(self.b));
